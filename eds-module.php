...
$module_info = array(
	...
	"en"	=>	array(
		"Application"	=>	array(
				"Installation date"	=>	"2016-03-12 11:06:37",
				"Website"	=>	"<a href='https://www.adminer.org' target='_blank'>https://www.adminer.org</a>"
		),
		...
		"How to uninstall this module ?"	=>	array(
				"If you want to uninstall this module, you just have to<br />delete the folder"	=>	"<br />[modules folder]\\adminer424",
		),	
	),
	"fr"	=>	array(
		"Application"	=>	array(
				"Date d'installation"	=>	"2016-03-12 11:06:37",
				"Site web"	=>	"<a href='https://www.adminer.org' target='_blank'>https://www.adminer.org</a>"
		),
		"Comment d&eacute;sinstaller ce module ?"	=>	array(
				"Si vous voulez d&eacute;sinstaller ce module, il suffit de supprimer le r&eacute;pertoire"	=>	"<br />[modules folder]\\\adminer424",
		),
	),	
);
...
if (isset($conf_httpserver['httpserver_folder'])
	AND $conf_httpserver['httpserver_folder'] != ""
	...
	<div class="row panel panel-default" style="margin:0px 0px 5px 0px;padding:5px;background-color:#f6f8f8;border:none;" data-toggle="tooltip" data-placement="top" title="Start a HTTP server and MySQL!">
		...
		<div class="col-sm-10" style="padding:5px 0px 0px 5px;">
			...
			<span role="button" style="padding:0px 10px 0px 10px;opacity:0.5;color:silver;cursor:pointer;" tabindex="0" class="delete_alias glyphicon glyphicon-cog" aria-hidden="true" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-html="true" title="<b class='text-center'>Adminer 5.2.3.6</b>" data-content="<?php echo htmlentities($application_info) ?>"></span>
		</div>
